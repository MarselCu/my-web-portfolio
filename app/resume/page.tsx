...
export default function Resume() {
  return (
    ...
    >
      <div className="p-[15px] xl:px-16 mx-auto w-full max-w-5xl">
        <Tabs defaultValue="experience" className="flex flex-col xl:flex-row gap-8">
          ...
          <div className="min-h-[70vh] w-full relative">
            <TabsContent value="experience" className="w-full absolute inset-0">
                ...
                <ScrollArea className="h-[400px]">
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {experiences.items.map((item, index) => (
                      <li key={index} className="bg-[#232329] h-[180px] py-5 px-8 rounded-lg flex flex-col justify-center items-center lg:items-start gap-1">
                        <span className="text-app-secondary">{item.duration}</span>
                        <h3 className="text-lg max-w-[280px] min-h-[50px] text-center lg:text-left">{item.position}</h3>
            ...
            <TabsContent value="skill" className="w-full absolute inset-0">
              <div className="flex flex-col gap-6 text-center xl:text-left">
            ...
            <TabsContent value="education" className="w-full absolute inset-0">
              <div className="flex flex-col gap-6 text-center xl:text-left">
                ...
                <ScrollArea className="h-[400px]">
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {educations.items.map((item, index) => (
                      <li key={index} className="bg-[#232329] h-[180px] py-5 px-8 rounded-lg flex flex-col justify-center items-center lg:items-start gap-1">
                        <span className="text-app-secondary">{item.duration}</span>
                        <h3 className="text-lg max-w-[280px] min-h-[50px] text-center lg:text-left">{item.program}</h3>
                        <div className="flex items-center gap-3">
                          <span className="w-[6px] h-[6px] rounded-full bg-app-secondary"></span>
            ...
            <TabsContent value="about" className="w-full absolute inset-0">
              <div className="flex flex-col gap-6 text-center xl:text-left">
